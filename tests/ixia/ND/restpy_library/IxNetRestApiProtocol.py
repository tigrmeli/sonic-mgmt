...
class Protocol(object):
    ...
    def createTopologyNgpf(self, portList, topologyName=None):
        ...
        if len(vportList) != len(portList):
            raise IxNetRestApiException(
                "createTopologyNgpf: There is not enough vports created to match the number of ports."
            )

        topologyData = {"vports": vportList}
        if topologyName is not None:
    ...
    def configLacpNgpf(self, ethernetObj, **kwargs):
        ...
        for lacpAttribute in lacpAttributes:
            if lacpAttribute in kwargs:
                ...
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multiValue + "/singleValue",
                    data={"value": kwargs[lacpAttribute]},
                )
                data.update({"value": kwargs[lacpAttribute]})

        return lacpObj

    def createEthernetNgpf(
        ...
        """
        ethernetObj = self.configEthernetNgpf(
            obj=obj,
            port=port,
            portName=portName,
    ...
    def configEthernetNgpf(
        ...
        # To modify
        if ngpfEndpointName:
            ethernetObj = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="ethernet"
            )
            createNewEthernetObj = False
        ...
        if port:
            ...
            ethernetObj = self.getProtocolObjFromProtocolList(
                x["deviceGroup"], "ethernet"
            )[0]
            createNewEthernetObj = False
        ...
        if "multiplier" in kwargs:
            self.configDeviceGroupMultiplier(
                objectHandle=ethernetObj,
        ...
        if "macAddress" in kwargs:
            ...
            if multivalueType == "random":
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multivalue, data={"pattern": "random"}
                )
            else:
                self.configMultivalue(
                    multivalue, multivalueType, data=kwargs["macAddress"]
                )
            ...
            if "macAddressPortStep" in kwargs:
                ...
                if "macAddressPortStep" in kwargs:
                    if kwargs["macAddressPortStep"] != "disabled":
                        self.ixnObj.patch(
                            portStepMultivalue,
                            data={"step": kwargs["macAddressPortStep"]},
                        )
                    if kwargs["macAddressPortStep"] == "disabled":
        ...
        if "vlanId" in kwargs and kwargs["vlanId"] is not None:
            # Enable VLAN
            if createNewEthernetObj is True:
    ...
    def getDeviceGroupIsIsL3RouterObj(self, deviceGroupObj):
        ...
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + deviceGroupObj + "/isisL3Router"
        )
    ...
    def configIsIsL3RouterNgpf(self, isisL3RouterObj, **data):
        ...
        if "enableBIER" in data:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + isisL3RouterObj,
                data={"enableBIER": data["enableBIER"]},
            )
        ...
        for attribute in ["active", "bierNFlag", "bierRFlag"]:
            if attribute in data:
                ...
                self.ixnObj.logInfo(
                    "Configuring ISIS BIER Subdomain multivalue attribute: %s"
                    % attribute
                )
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multivalue + "/singleValue",
    ...
    def configIsIsBierSubDomainListNgpf(self, isisL3RouterObj, **data):
        ...
        """
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + isisL3RouterObj + "/isisBierSubDomainList"
        )
        for attribute in ["active", "subDomainId", "BAR"]:
            if attribute in data:
                multiValue = response.json()[attribute]
                self.ixnObj.logInfo(
                    "Configuring ISIS DIER Subdomain multivalue attribute: %s"
                    % attribute
                )
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multiValue + "/singleValue",
    ...
    def configIpv4Ngpf(
        ...
        # To modify
        if ngpfEndpointName:
            ipv4Obj = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="ipv4"
            )
            createNewIpv4Obj = False
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + ipv4Obj, data={"name": kwargs["name"]}
            )

        if "multiplier" in kwargs:
            self.configDeviceGroupMultiplier(
                objectHandle=ipv4Obj,
                multiplier=kwargs["multiplier"],
                applyOnTheFly=False,
            )
        ...
        if "ipv4Address" in kwargs:
            ...
            if multivalueType == "random":
                ...
                self.configMultivalue(
                    multivalue, multivalueType, data=kwargs["ipv4Address"]
                )
        ...
        if "ipv4AddressPortStep" in kwargs:
            ...
            if kwargs["ipv4AddressPortStep"] != "disabled":
                self.ixnObj.patch(
                    portStepMultivalue, data={"step": kwargs["ipv4AddressPortStep"]}
                )
            if kwargs["ipv4AddressPortStep"] == "disabled":
                self.ixnObj.patch(portStepMultivalue, data={"enabled": False})
        ...
        if "gateway" in kwargs:
            ...
            if multivalueType == "random":
                ...
                self.configMultivalue(
                    multivalue, multivalueType, data=kwargs["gateway"]
                )
        ...
        if "gatewayPortStep" in kwargs:
            ...
            if kwargs["gatewayPortStep"] != "disabled":
                self.ixnObj.patch(
                    portStepMultivalue, data={"step": kwargs["gatewayPortStep"]}
                )
            if kwargs["gatewayPortStep"] == "disabled":
                self.ixnObj.patch(portStepMultivalue, data={"enabled": False})
        ...
        if "resolveGateway" in kwargs:
            ...
            self.configMultivalue(
                multivalue, "singleValue", data={"value": kwargs["resolveGateway"]}
            )
        ...
        if "prefix" in kwargs:
            ...
            self.configMultivalue(multivalue, multivalueType, data=kwargs["prefix"])
        if createNewIpv4Obj is True:
    ...
    def configIpv4Loopback(self, deviceGroupObj, **kwargs):
        ...
        response = self.ixnObj.post(
            self.ixnObj.httpHeader + deviceGroupObj + "/ipv4Loopback"
        )
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + ipv4LoopbackObj, data={"name": kwargs["name"]}
            )
        ...
        if "multiplier" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + ipv4LoopbackObj,
        ...
        if "prefix" in kwargs:
            ...
            # self.configMultivalue(multivalue, 'singleValue', data={'value': kwargs['prefix']})
            self.configMultivalue(
                multivalue, multivalueType, data={"value": kwargs["prefix"]}
            )
    ...
    def configDhcpClientV4(self, obj, **kwargs):
        ...
        Syntax
            ...
            PATCH: /api/v1/sessions/{id}/ixnetwork/topology/{id}/deviceGroup/{id}/ -> next line is continue
                    ethernet/{id}/ipv4/{id}/dhcpv4client/{id}
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + dhcpObj, data={"name": kwargs["name"]}
            )
        ...
        dhcpAttributes = [
            ...
            "dhcp4ServerAddress",
            "dhcp4GatewayMac",
            "dhcp4GatewayAddress" "useRapidCommit",
            "dhcp4GatewayMac",
            "renewTimer",
        ]
        ...
        for dhcpAttribute in dhcpAttributes:
            if dhcpAttribute in kwargs:
                ...
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multiValue + "/singleValue",
                    data={"value": kwargs[dhcpAttribute]},
                )
    ...
    def configDhcpServerV4(self, obj, **kwargs):
        ...
        Parameters
            obj: <str>: To create new DHCP: /api/v1/sessions/1/ixnetwork/ -> next line is continue
                topology/1/deviceGroup/1/ethernet/1/ipv4/1
            obj: <str>: To modify DHCP server: /api/v1/sessions/1/ixnetwork/ -> next line is continue
                topology/1/deviceGroup/1/ethernet/1/ipv4/1/dhcpv4server/1
        ...
        Syntax
            POST:  /api/v1/sessions/{id}/ixnetwork/ -> next line is continue
                topology/{id}/deviceGroup/{id}/ethernet/{id}/ipv4/{id}/dhcpv4server
            PATCH: /api/v1/sessions/{id}/ixnetwork/ -> next line is continue
                topology/{id}/deviceGroup/{id}/ethernet/{id}/ipv4/{id}/dhcpv4server/{id}
        ...
        if "multiplier" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + dhcpObj,
                data={"multiplier": kwargs["multiplier"]},
            )

        dhcpServerSessionObjResponse = self.ixnObj.get(
            self.ixnObj.httpHeader + dhcpObj + "/dhcp4ServerSessions"
        )
        dhcpServerSessionAttributes = [
            "defaultLeaseTime",
            "echoRelayInfo",
            "ipAddress",
            "ipAddressIncrement",
        ...
        **kwargs
        ...
        if ngpfEndpointName:
            ospfObj = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="ospfv2"
            )
        ...
        # To modify
        if routerId:
            ospfObj = self.getNgpfObjectHandleByRouterId(
                routerId=routerId, ngpfEndpointObject="ospfv2"
            )
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + ospfObj, data={"name": kwargs["name"]}
            )

        for key, value in ospfObjResponse.json().items():
            if key != "links":
                if bool(re.search("multivalue", str(value))) is True:
                    if key in kwargs:
                        multiValue = ospfObjResponse.json()[key]
                        self.ixnObj.logInfo(
                            "Configuring OSPF multivalue attribute: %s" % key
                        )
                        self.ixnObj.patch(
                            self.ixnObj.httpHeader + multiValue + "/singleValue",
                    ...
                    if key in kwargs:
                        self.ixnObj.patch(
                            self.ixnObj.httpHeader + ospfObj, data={key: kwargs[key]}
                        )
        ...
        if any(attribute in ospfv2AttributeList for attribute in kwargs):
            ospfRouterUrl = (
                self.ixnObj.httpHeader + ospfObj.split("ethernet")[0] + "ospfv2Router"
            )

            ospfRouterObjResponse = self.ixnObj.get(
                ospfRouterUrl
                + "/"
                + str(self.ixnObj.get(ospfRouterUrl).json()[0]["id"])
            )
                ...
                if key != "links":
                    if bool(re.search("multivalue", str(value))) is True:
                        if key in kwargs:
                            ...
                            self.ixnObj.logInfo(
                                "Configuring OSPF Router multivalue attribute: %s" % key
                            )
                            self.configMultivalue(
                                multiValue, "singleValue", data={"value": kwargs[key]}
                            )
                    else:
                        if key in kwargs:
                            self.ixnObj.patch(
                                self.ixnObj.httpHeader + ospfRouterObjResponse,
                                data={key: kwargs[key]},
                            )
        ...
        if any(attribute in ospfv2TrafficEngAttributeList for attribute in kwargs):
            ...
            ospfTrafficEngObjResponse = self.ixnObj.get(
                self.ixnObj.httpHeader + ospfTrafficEngObj
            )
            ...
            for key, value in ospfTrafficEngObjResponse.json().items():
                if key != "links":
                    if bool(re.search("multivalue", str(value))) is True:
                        ...
                        if key in kwargs:
                            self.ixnObj.patch(
                                self.ixnObj.httpHeader + ospfTrafficEngObjResponse,
                                data={key: kwargs[key]},
                            )
    ...
    def configOspfv3(
        ...
        **kwargs
        ...
        if ngpfEndpointName:
            ospfObj = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="ospfv3"
            )
        ...
        if routerId:
            ospfObj = self.getNgpfObjectHandleByRouterId(
                routerId=routerId, ngpfEndpointObject="ospfv3"
            )
        ...
        if any(attribute in ospfv3AttributeList for attribute in kwargs):
            ospfRouterUrl = (
                self.ixnObj.httpHeader + ospfObj.split("ethernet")[0] + "ospfv3Router"
            )
    ...
    def configBgp(
        ...
        **kwargs
        ...
        Parameters
            obj: <str>: None or Either an IPv4 object or a BGP object.
               ...
               If modifying, you could provide the bgp object handle using the obj parameter:
                  BGP object example: /api/v1/sessions/1/ixnetwork -> next line is continue
                    /topology/1/deviceGroup/1/ethernet/1/ipv4/1/bgpIpv4Peer/1
        ...
        Syntax
            POST:  /api/v1/sessions/{id}/ixnetwork/topology/{id}/ -> next line is continue
            deviceGroup/{id}/ethernet/{id}/ipv4/{id}/bgpIpv4Peer
            PATCH: /api/v1/sessions/{id}/ixnetwork/topology/{id}/ -> next line is continue
            deviceGroup/{id}/ethernet/{id}/ipv4/{id}/bgpIpv4Peer/{id}
        ...
        # To modify
        if ngpfEndpointName:
            bgpObj = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="bgpIpv4Peer"
            )

        # To modify
        if port:
            x = self.getProtocolListByPortNgpf(port=port)
            bgpObj = self.getProtocolObjFromProtocolList(
        ...
        # To modify
        if routerId:
            bgpObj = self.getNgpfObjectHandleByRouterId(
                routerId=routerId, ngpfEndpointObject="bgpIpv4Peer"
            )
        ...
        bgpObjResponse = self.ixnObj.get(
            self.ixnObj.httpHeader + bgpObj + "?links=true"
        )

        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + bgpObj, data={"name": kwargs["name"]}
            )

        # For BgpIpv4Peer
        if "enableBgp" in kwargs and kwargs["enableBgp"] is True:
        ...
        # For BgpIpv6Peer
        if "active" in kwargs and kwargs["active"] is True:
            ...
            if key != "links" and key not in ["dutIp"]:
                if bool(re.search("multivalue", str(value))) is True:
                    if key in kwargs:
                        ...
                        self.ixnObj.logInfo(
                            "Configuring BGP multivalue attribute: %s" % key
                        )
                        self.ixnObj.patch(
                            self.ixnObj.httpHeader + multiValue + "/singleValue",
                            data={"value": kwargs[key]},
                    ...
                    if key in kwargs:
                        self.ixnObj.patch(
                            self.ixnObj.httpHeader + bgpObj, data={key: kwargs[key]}
                        )
    ...
    def configBgpIpv6(
        ...
        **kwargs
        ...
        """
        return self.configBgp(
            obj, routerId, port, portName, ngpfEndpointName, hostIp, **kwargs
        )
    ...
    def configIgmpHost(self, ipObj, **kwargs):
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + igmpObj, data={"name": kwargs["name"]}
            )
        ...
        for igmpAttribute in igmpAttributes:
            if igmpAttribute in kwargs:
                ...
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multiValue + "/singleValue",
                    data={"value": kwargs[igmpAttribute]},
                )
    ...
    def configMpls(self, ethernetObj, **kwargs):
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + mplsObj, data={"name": kwargs["name"]}
            )
    ...
    def configVxlanNgpf(
        ...
        **kwargs
        ...
        Parameters
               obj: <str>: IPv4 Obj example: /api/v1/sessions/{id}/ -> next line is continue
                            ixnetwork/topology/{id}/deviceGroup/{id}/ethernet/{id}/ipv4/{id}
                           VxLAN Obj example: /api/v1/sessions/{id}/ -> next line is continue
                           ixnetwork/topology/{id}/deviceGroup/{id}/ethernet/{id}/ipv4/{id}/vxlan/{id}
        ...
        # To modify
        if ngpfEndpointName:
            vxlanId = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="vxlan"
            )
        ...
        # To modify
        if routerId:
            vxlanId = self.getNgpfObjectHandleByRouterId(
                routerId=routerId, ngpfEndpointObject="vxlan"
            )
        ...
        for key, value in kwargs.items():
            if key == "vtepName":
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + vxlanId, data={"name": value}
                )
            ...
            if key == "vtepIpv4Multicast":
                ...
                data = {
                    "start": kwargs["vtepIpv4Multicast"]["start"],
    ...
    def deleteRsvpTeLsps(self, rsvpTunnelObj):
        ...
        Parameter
            rsvrTunnelObj: <str>: /api/v1/sessions/{id}/ixnetwork/ -> next line is continue
            topology/{id}/deviceGroup/{id}/ethernet/{id}/ipv4/{id}/rsvpteLsps/{id}

        Syntax
            DELETE: /api/v1/sessions/{id}/ixnetwork/topology/{id}/ -> next line is continue
            deviceGroup/{id}/ethernet/{id}/ipv4/{id}/rsvpteLsps/{id}
        """
    ...
    def configNetworkGroup(self, **kwargs):
        ...
        if "create" not in kwargs and "modify" not in kwargs:
            raise IxNetRestApiException(
                "configNetworkGroup requires either a create or modify parameter."
            )
        ...
        if "create" in kwargs:
            ...
            response = self.ixnObj.post(
                self.ixnObj.httpHeader + deviceGroupObj + "/networkGroup"
            )
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + networkGroupObj, data={"name": kwargs["name"]}
            )

        if "multiplier" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + networkGroupObj,
                data={"multiplier": kwargs["multiplier"]},
            )
        ...
        if "create" in kwargs:
            if ipVersion == "ipv6":
                ...
                response = self.ixnObj.post(
                    self.ixnObj.httpHeader + networkGroupObj + "/ipv6PrefixPools"
                )
                ...
                response = self.ixnObj.post(
                    self.ixnObj.httpHeader + networkGroupObj + "/ipv4PrefixPools"
                )
                prefixObj = response.json()["links"][0]["href"]
        else:
            if ipVersion == "ipv6":
        ...
        if "numberOfAddresses" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + prefixObj,
                data={"numberOfAddresses": kwargs["numberOfAddresses"]},
            )
    ...
    def configNetworkGroupWithTopology(self, topoType="Linear", **kwargs):
        ...
        if "create" in kwargs:
            ...
            response = self.ixnObj.post(
                self.ixnObj.httpHeader + networkGroupObj + "/networkTopology"
            )
            response = self.ixnObj.post(
                self.ixnObj.httpHeader
                + networkGroupObj
                + "/networkTopology/"
                + self.topoTypeDict[topoType]
            )
            networkTopologyObj = response.json()["links"][0]["href"]
        else:
            networkTopologyObj = (
                networkGroupObj + "/networkTopology/" + self.topoTypeDict[topoType]
            )
    ...
    def configNetworkTopologyProperty(self, networkGroupObj, pseudoRouter, **kwargs):
        ...
        Syntax
            PATCH: /api/v1/sessions/{id}/ixnetwork/topology/{id}/ -> next line is continue
            deviceGroup/{id}/networkGroup/{id}/networkTopology/simRouter/1{id}
        """
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + networkGroupObj + "/networkTopology/simRouter/1"
        )
        self.ixnObj.logInfo("Config Network Group advertising routes")
    ...
    def prefixPoolsConnector(self, prefixPoolsObj, protocolObj):
        ...
        """
        self.ixnObj.patch(
            self.ixnObj.httpHeader + prefixPoolsObj + "/connector",
    ...
    def networkGroupWithTopologyConnector(self, networkGroupObj, protocolObj):
        ...
        self.ixnObj.patch(
            self.ixnObj.httpHeader
            + networkGroupObj
            + "/networkTopology/simRouter/1/connector",
            data={"connectedTo": protocolObj},
        )

    def configBgpRouteRangeProperty(
        self, prefixPoolsObj, protocolRouteRange, data, asPath
    ):
        """
        Description
        ...
        Syntax
            PATCH: /api/v1/sessions/{id}/ixnetwork/topology/{id}/deviceGroup/ -> next line is continue
            {id}/networkGroup/{id}/ipv4PrefixPools/{id}/protocolRouterRange/{id}
        """
        response = self.ixnObj.get(
            self.ixnObj.httpHeader
            + prefixPoolsObj
            + "/{0}/1".format(protocolRouteRange)
        )
        routeRangeObj = response.json()["links"][0]["href"]
        for attribute, value in data.items():
            multivalue = response.json()[attribute]
            self.ixnObj.logInfo(
                "Configuring PrefixPools {0} Route Property multivalue attribute: {1}".format(
                    protocolRouteRange, attribute
                )
            )
            self.ixnObj.patch(
                self.ixnObj.httpHeader + multivalue + "/singleValue",
        ...
        if asPath != {}:
            response = self.ixnObj.get(
                self.ixnObj.httpHeader
                + routeRangeObj
                + "/{0}/1".format("bgpAsPathSegmentList")
            )
            for attribute, value in asPath.items():
                multivalue = response.json()[attribute]
                self.ixnObj.logInfo(
                    "Configuring AsPath {0} Segment Property multivalue attribute: {1}".format(
                        "bgpAsPathSegmentList", attribute
                    )
                )
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multivalue + "/singleValue",
                    data={"value": asPath[attribute]},
                )
    ...
    def configPrefixPoolsIsisL3RouteProperty(self, prefixPoolsObj, **data):
        ...
        """
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + prefixPoolsObj + "/isisL3RouteProperty/1"
        )
        for attribute, value in data.items():
            multivalue = response.json()[attribute]
            self.ixnObj.logInfo(
                "Configuring PrefixPools ISIS L3 Route Property multivalue attribute: %s"
                % attribute
            )
            self.ixnObj.patch(
                self.ixnObj.httpHeader + multivalue + "/singleValue",
    ...
    def configPrefixPoolsRouteProperty(
        self, prefixPoolsObj, protocolRouteRange, **data
    ):
        """
        Description
            Configure Network Group Prefix Pools for all Route properties.
        ...
        Syntax
            PATCH: /api/v1/sessions/{id}/ixnetwork/topology/{id}/ -> next line is continue
            deviceGroup/{id}/networkGroup/{id}/ipv4PrefixPools/{id}/protocolRouterRange/{id}
        """
        """
        response = self.ixnObj.get(self.ixnObj.httpHeader + prefixPoolsObj + '/{0}/1'.format(protocolRouteRange))
        for attribute, value in data.items():
            multivalue = response.json()[attribute]
            self.ixnObj.logInfo('Configuring PrefixPools  -> next line is continue
            {0} Route Property multivalue attribute: {1}'.format(protocolRouteRange, attribute))
            self.ixnObj.patch(self.ixnObj.httpHeader+multivalue+" -> next line is continue
        ...
        for attribute, value in data.items():
            ...
            if type(value) == dict:
                if "direction" in value:
                    self.ixnObj.patch(
                        self.ixnObj.httpHeader + multivalue + "/counter", data=value
                    )
            else:
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multivalue + "/singleValue",
    ...
    def configMultivalue(self, multivalueUrl, multivalueType, data):
        ...
        """
        self.ixnObj.patch(
            self.ixnObj.httpHeader + multivalueUrl + "/" + multivalueType, data=data
        )
    ...
    def getMultivalueValues(self, multivalueObj, silentMode=False):
        ...
        """
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + multivalueObj + "?includes=count",
        ...
        data = {"arg1": multivalueObj, "arg2": 0, "arg3": count}
        response = self.ixnObj.post(
            self.ixnObj.sessionUrl + "/multivalue/operations/getValues",
            data=data,
            silentMode=silentMode,
        )
        self.ixnObj.waitForComplete(
    ...
    def verifyProtocolSessionsUp(
        self, protocolViewName="BGP Peer Per Port", timeout=60
    ):
        """
        Description
    ...
    def verifyProtocolSessionsUp1(
        ...
        for counter in range(1, timeout + 1):
            stats = self.ixnObj.getStatsPage(
                viewName=protocolViewName, displayStats=False
            )
            # Length stats.keys() represents total ports.
    ...
    def verifyProtocolSessionsUp2(
        self, protocolViewName="Protocols Summary", timeout=60
    ):
        """
        Description
        ...
        for counter in range(1, timeout + 1):
            stats = self.statObj.getStatsData(
                viewName=protocolViewName, displayStats=False, silentMode=True
            )
            self.ixnObj.logInfo(
                "\n%-16s %-14s %-16s %-23s %-22s"
                % (
            ...
            # Length stats.keys() represents total ports or total protocols.
            ...
            if sessionNotStartedFlag == 1:
                if counter < timeout:
                    sessionNotStartedFlag = 0
                    self.ixnObj.logInfo(
                        "Protocol sessions are not started yet. Waiting {0}/{1} seconds".format(
                            counter, timeout
                        )
                    )
                    time.sleep(1)
    ...
    def startAllOspfv2(self):
        ...
        queryData = {
            "from": "/",
            "nodes": [
                {"node": "topology", "properties": ["name"], "where": []},
        ...
        for topologyObj in queryResponse.json()["result"][0]["topology"]:
            for deviceGroupObj in topologyObj["deviceGroup"]:
                if deviceGroupObj["ethernet"][0]["ipv4"][0]["rsvpteIf"] != []:
                    for rsvpTeIfObj in deviceGroupObj["ethernet"][0]["ipv4"][0][
                        "rsvpteIf"
                    ]:
        ...
        for topologyObj in queryResponse.json()["result"][0]["topology"]:
            for deviceGroupObj in topologyObj["deviceGroup"]:
                if deviceGroupObj["ethernet"][0]["ipv4"][0]["rsvpteLsps"] != []:
                    for rsvpTeLspsObj in deviceGroupObj["ethernet"][0]["ipv4"][0][
                        "rsvpteLsps"
                    ]:
    ...
    def verifyDeviceGroupStatus(self):
        queryData = {
            "from": "/",
            "nodes": [
                {"node": "topology", "properties": [], "where": []},
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            for deviceGroup in topology["deviceGroup"]:
                ...
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + deviceGroupObj, silentMode=False
                )
                # Verify if the Device Group is enabled. If not, don't go further.
                enabledMultivalue = response.json()["enabled"]
                enabled = self.ixnObj.getMultivalueValues(
                    enabledMultivalue, silentMode=False
                )
                if enabled[0] == "true":
                    for counter in range(1, deviceGroupTimeout + 1):
                        ...
                        self.ixnObj.logInfo(
                            "\t\tStatus: %s" % deviceGroupStatus, timestamp=False
                        )
                        if (
                            counter < deviceGroupTimeout
                            and deviceGroupStatus != "started"
                        ):
                            self.ixnObj.logInfo(
                                "\t\tWaiting %d/%d seconds ..."
                                % (counter, deviceGroupTimeout),
                    ...
                    if deviceGroup["deviceGroup"] != []:
                        ...
                        for counter in range(1, deviceGroupTimeout):
                            response = self.ixnObj.get(
                                self.ixnObj.httpHeader + innerDeviceGroupObj,
                                silentMode=True,
                            )
                            ...
                            self.ixnObj.logInfo(
                                "\t   Status: %s" % innerDeviceGroupStatus,
                                timestamp=False,
                            )
                            if (
                                counter < deviceGroupTimeout
                                and innerDeviceGroupStatus != "started"
                            ):
                                self.ixnObj.logInfo(
                                    "\tWait %d/%d" % (counter, deviceGroupTimeout),
                                    timestamp=False,
                                )
                                time.sleep(1)
                            if (
    ...
    def startProtocol(self, protocolObj):
        ...
        Parameters
            protocolObj: <str|obj>: Ex: /api/v1/sessions/1/ixnetwork/ -> next line is continue
            topology/1/deviceGroup/1/ethernet/1/ipv4/1/bgpIpv4Peer/1
    ...
    def stopProtocol(self, protocolObj):
        ...
        Parameters
            protocolObj: <str|obj>: /api/v1/sessions/1/ixnetwork/ -> next line is continue
                topology/1/deviceGroup/1/ethernet/1/ipv4/1/bgpIpv4Peer/1
    ...
    def stopTopology(self, topologyObjList="all"):
        ...
        self.ixnObj.post(
            self.ixnObj.sessionUrl + "/topology/operations/stop",
            data={"arg1": topologyObjList},
        )
        # self.ixnObj.waitForComplete(response, url + "/" + response.json()["id"])
    ...
    def verifyProtocolSessionsNgpf(self, protocolObjList=None, timeout=90):
        ...
        Syntaxes
            GET:  http://10.219.117.103:11009/api/v1/sessions/1/ixnetwork/ -> next line is continue
        ...
        for eachProtocol in protocolObjList:
            ...
            for timer in range(1, timerStop + 1):
                ...
                # ['up']
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + eachProtocol, silentMode=True
                )
                # Started
                ...
                self.ixnObj.logInfo(
                    "\tprotocolSessionStatus: %s" % protocolSessionStatus,
                    timestamp=False,
                )
                self.ixnObj.logInfo(
                    "\tsessionStatusResponse: %s" % sessionStatus, timestamp=False
                )
                if timer < timerStop:
                    if protocolSessionStatus != "started":
                        self.ixnObj.logInfo(
                            "\tWait %s/%s seconds" % (timer, timerStop), timestamp=False
                        )
                        time.sleep(1)
                        continue
                    ...
                    if "up" not in sessionStatus:
                        self.ixnObj.logInfo(
                            "\tProtocol session is down: Wait %s/%s seconds"
                            % (timer, timerStop),
                            timestamp=False,
                        )
                        time.sleep(1)
                    ...
                    if "up" in sessionStatus:
                        self.ixnObj.logInfo(
                            "Protocol sessions are all up: {0}".format(protocolName)
                        )
                        break
                ...
                if timer == timerStop:
                    if "notStarted" in protocolSessionStatus:
                        raise IxNetRestApiException(
                            "\tverifyProtocolSessions: {0} session failed to start".format(
                                protocolName
                            )
                        )
                    ...
                    if protocolSessionStatus == "started" and "down" in sessionStatus:
                        ...
                        if protocolName == "ipv4":
                            ...
                            for eachSessionStatus in sessionStatus:
                                self.ixnObj.logInfo(
                                    "eachSessionStatus index: {0} {1}".format(
                                        eachSessionStatus, index
                                    ),
                                    timestamp=False,
                                )
                            ...
                            ipAddressList = self.ixnObj.getMultivalueValues(
                                ipMultivalue, silentMode=True
                            )
                            self.ixnObj.logWarning("ARP failed on IP interface:")
                            for eachIpIndex in ipInterfaceIndexList:
                                self.ixnObj.logInfo(
                                    "\t{0}".format(ipAddressList[eachIpIndex]),
                                    timestamp=False,
                                )
                        else:
                            self.ixnObj.logWarning(
                                "\tverifyProtocolSessions: {0} session failed".format(
                                    protocolName
                                )
                            )

                        raise IxNetRestApiException(
                            "Verify protocol sessions failed: {0}".format(protocolName)
                        )
    ...
    def verifyAllProtocolSessionsInternal(self, protocol, timeout=120, silentMode=True):
        ...
        for timer in range(startCounter, timeout + 1):
            ...
            self.ixnObj.logInfo(
                "\tTotal sessions: %d" % len(currentStatus), timestamp=False
            )
            totalDownSessions = 0
            for eachStatus in currentStatus:
                if eachStatus != "up":
                    totalDownSessions += 1
            self.ixnObj.logInfo(
                "\tTotal sessions Down: %d" % totalDownSessions, timestamp=False
            )
            # self.ixnObj.logInfo('\tCurrentStatus: %s' % currentStatus, timestamp=False)

            if (
                timer < timeout
                and [element for element in sessionDownList if element in currentStatus]
                == []
            ):
            ...
            if (
                ...
                self.ixnObj.logInfo(
                    "\tWait %d/%d seconds" % (timer, timeout), timestamp=False
                )
                time.sleep(1)
                continue
    ...
    def verifyAllProtocolSessionsNgpf(self, timeout=120, silentMode=False):
        ...
        for topology in topologyGroupList:
            for deviceGroup in topology["deviceGroup"]:
                ...
                enabledMultivalue = response.json()["enabled"]
                response = self.ixnObj.getMultivalueValues(
                    enabledMultivalue, silentMode=silentMode
                )
                ...
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + deviceGroup + "/ethernet",
                    silentMode=silentMode,
                )
                match = re.match(
                    "/api/v[0-9]+/sessions/[0-9]+/ixnetwork(.*)", deviceGroup
                )
                queryData = {
                    "from": match.group(1),
                ...
                for ethernet in ethernetList:
                    ...
                    for protocol in l2ProtocolList:
                        response = self.ixnObj.get(
                            self.ixnObj.httpHeader + ethernet + "/" + protocol,
                            silentMode=True,
                            ignoreError=True,
                        )
                        if response.json() == [] or "errors" in response.json():
                            continue
                        currentProtocolList = [
                            "%s/%s/%s" % (ethernet, protocol, str(i["id"]))
                    ...
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader + ethernet + "/ipv4",
                        silentMode=silentMode,
                    )
                    ipv4List = [
                        "%s/%s/%s" % (ethernet, "ipv4", str(i["id"]))
                        for i in response.json()
                    ]
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader + ethernet + "/ipv6",
                        silentMode=silentMode,
                    )
                    ipv6List = [
                        "%s/%s/%s" % (ethernet, "ipv6", str(i["id"]))
                        for i in response.json()
                    ]
                    for layer3Ip in ipv4List + ipv6List:
                        for protocol in l3ProtocolList:
                            response = self.ixnObj.get(
                                self.ixnObj.httpHeader + layer3Ip + "/" + protocol,
                                silentMode=True,
                                ignoreError=True,
                            )
                            if response.json() == [] or "errors" in response.json():
                                continue
                            currentProtocolList = [
                                "%s/%s/%s" % (layer3Ip, protocol, str(i["id"]))
                                for i in response.json()
                            ]
                            for currentProtocol in currentProtocolList:
                                self.verifyAllProtocolSessionsInternal(
    ...
    def getIpObjectsByTopologyObject(self, topologyObj, ipType="ipv4"):
        ...
        deviceGroupList = [
            "%s/%s/%s" % (topologyObj, "deviceGroup", str(i["id"]))
            for i in deviceGroupResponse.json()
        ]
        for deviceGroup in deviceGroupList:
            response = self.ixnObj.get(deviceGroup + "/ethernet")
            ethernetList = [
                "%s/%s/%s" % (deviceGroup, "ethernet", str(i["id"]))
                for i in response.json()
            ]
            for ethernet in ethernetList:
    ...
    def getAllTopologyList(self):
        ...
        topologyList = [
            "%s/%s/%s" % (self.ixnObj.sessionUrl, "topology", str(i["id"]))
            for i in response.json()
        ]
        return topologyList
    ...
    def clearAllTopologyVports(self):
        response = self.ixnObj.get(self.ixnObj.sessionUrl + "/topology")
        topologyList = [
            "%s%s" % (self.ixnObj.httpHeader, str(i["links"][0]["href"]))
            for i in response.json()
        ]
    ...
    def modifyTopologyPortsNgpf(self, topologyObj, portList, topologyName=None):
        ...
        if len(vportList) != len(portList):
            raise IxNetRestApiException(
                "modifyTopologyPortsNgpf: There is not enough vports created to match the number of ports."
            )
        self.ixnObj.logInfo("vportList: %s" % vportList)
        topologyData = {"vports": vportList}
        self.ixnObj.patch(
            self.ixnObj.httpHeader + topologyObj, data=topologyData
        )
    ...
    def sendArpNgpf(self, ipv4ObjList):
        ...
        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/operations/sendarp"
        )
    ...
    def sendPing(self, srcIpList=None, destIp=None):
        ...
        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/operations/sendping"
        )
        queryResponse = self.ixnObj.query(data=queryData)
        srcIpIndexList = []
        noSrcIpIndexFound = []
            ...
            for ipv4 in topology["deviceGroup"][0]["ethernet"][0]["ipv4"]:
                ...
                if srcIpIndexList != []:
                    ...
                    if noSrcIpIndexFound != []:
                        self.ixnObj.logError(
                            "No srcIp address found in configuration: {0}".format(
                                noSrcIpIndexFound
                            )
                        )
        ...
        if srcIpIndexList == []:
            raise IxNetRestApiException(
                "No srcIp addresses found in configuration: {0}".format(srcIpList)
            )
    ...
    def verifyNgpfProtocolStarted(self, protocolObj, ignoreFailure=False, timeout=30):
        ...
        for counter in range(1, timeout + 1):
            ...
            if counter < timeout:
                ...
                for session in sessionStatus:
                    if session in ["notStarted", "down"]:
                        count += 1
                self.ixnObj.logInfo(
                    "\t{0} out of {1} sessions are still down".format(
                        count, len(sessionStatus)
                    ),
                    timestamp=False,
                )
                self.ixnObj.logInfo(
                    "\tWait %d/%d seconds" % (counter, timeout), timestamp=False
                )
                time.sleep(1)
            ...
            if counter == timeout:
                ...
                if count != 0:
                    errMsg = "{0} out of {1} sessions failed to start".format(
                        count, len(sessionStatus)
                    )
                    self.ixnObj.logError(errMsg)
                    if ignoreFailure is False:
            ...
            if counter < timeout:
                ...
                if flag == 0:
                    self.ixnObj.logInfo(
                        "\tTotal of {0} sessions started".format(len(sessionStatus)),
                        timestamp=False,
                    )
                    return 0

    def deviceGroupProtocolStackNgpf(
        self, deviceGroupObj, ipType, arpTimeout=3, silentMode=True
    ):
        """
        Description
        ...
        unresolvedArpList = []
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + deviceGroupObj + "/ethernet", silentMode=silentMode
        )
        ethernetObjList = [
            "%s/%s/%s" % (deviceGroupObj, "ethernet", str(i["id"]))
            for i in response.json()
        ]
        for ethernetObj in ethernetObjList:
            response = self.ixnObj.get(
                self.ixnObj.httpHeader + ethernetObj + "/" + ipType,
                ignoreError=True,
                silentMode=silentMode,
            )
            ...
            ipProtocolList = [
                "%s/%s/%s" % (ethernetObj, ipType, str(i["id"]))
                for i in response.json()
            ]
            if ipProtocolList == []:
                self.ixnObj.logWarning(
                    "{0} is not configured in {1}".format(ipType, ethernetObj)
                )
            ...
            for ipProtocol in ipProtocolList:
                ...
                for counter in range(1, arpTimeout + 1):
                    ...
                    if counter < arpTimeout and "down" in sessionStatus:
                        self.ixnObj.logInfo(
                            "\tARP is not resolved yet. Wait {0}/{1}".format(
                                counter, arpTimeout
                            ),
                            timestamp=False,
                        )
                ...
                protocolResponse = self.ixnObj.get(
                    self.ixnObj.httpHeader
                    + ipProtocol
                ...
                for index in range(0, len(resolvedGatewayMac)):
                    if bool(re.search(".*Unresolved.*", resolvedGatewayMac[index])):
                        ...
                        self.ixnObj.logError(
                            "Failed to resolve ARP: srcIp:{0} gateway:{1}".format(
                                srcIpAddrNotResolved, gatewayIp
                            )
                        )
    ...
    def verifyArp(self, ipType="ipv4", deviceGroupName=None, silentMode=True):
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            for deviceGroup in topology["deviceGroup"]:
                ...
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + deviceGroupObj, silentMode=silentMode
                )
                ...
                # Verify if the Device Group is enabled. If not, don't go further.
                enabledMultivalue = response.json()["enabled"]
                response = self.getMultivalueValues(
                    enabledMultivalue, silentMode=silentMode
                )
                if response[0] == "false":
                    continue
                ...
                for counter in range(1, timeout + 1):
                    ...
                    if counter < timeout and deviceGroupStatus == "starting":
                        self.ixnObj.logInfo(
                            "\tWait %d/%d" % (counter, timeout), timestamp=False
                        )
                        time.sleep(1)
                        continue
                    if counter < timeout and deviceGroupStatus in ["started", "mixed"]:
                        break
                    if counter == timeout and deviceGroupStatus not in [
                        "started",
                        "mixed",
                    ]:
                        raise IxNetRestApiException(
                            "\nDevice Group failed to come up: {0}.".format(
                                deviceGroupObj
                            )
                        )
                ...
                if deviceGroupStatus in ["started", "mixed"]:
                    startFlag = 1
                    arpResult = self.deviceGroupProtocolStackNgpf(
                        deviceGroupObj, ipType, silentMode=silentMode
                    )
                    if arpResult != 0:
                        unresolvedArpList = unresolvedArpList + arpResult

                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader + deviceGroupObj + "/deviceGroup",
                        silentMode=silentMode,
                    )
                    if response.status_code == 200 and response.json() != []:
                        ...
                        self.ixnObj.logInfo(
                            "\tdeviceGroup Status: %s" % deviceGroupStatus1,
                            timestamp=False,
                        )

                        if deviceGroupStatus == "started":
                            arpResult = self.deviceGroupProtocolStackNgpf(
                                innerDeviceGroupObj, ipType, silentMode=silentMode
                            )
                            if arpResult != 0:
                                unresolvedArpList = unresolvedArpList + arpResult
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            for deviceGroup in topology["deviceGroup"]:
                try:
                    ...
                    gatewayIpMultivalue = deviceGroup["ethernet"][0]["ipv4"][0][
                        "gatewayIp"
                    ]
                    self.ixnObj.logInfo("\t%s" % ipv4Href)
                    self.ixnObj.logInfo("\tIPv4 sessionStatus: %s" % ipv4SessionStatus)
                    self.ixnObj.logInfo(
                        "\tGatewayIpMultivalue: %s" % gatewayIpMultivalue
                    )
                    ...
                    if gatewayIp in valueList:
                        ...
                        queryData = {
                            "from": deviceGroup["ethernet"][0]["href"],
                            "nodes": [
                                {
                                    "node": "ipv4",
                                    "properties": ["gatewayIp", "resolvedGatewayMac"],
                                    "where": [],
                                }
                            ],
                        }
                        queryResponse = self.ixnObj.query(
                            data=queryData, silentMode=False
                        )
                        response = self.ixnObj.get(
                            self.ixnObj.httpHeader
                            + ipv4Href
                            + "?includes=resolvedGatewayMac"
                        )
                        ...
                        if "Unresolved" in gatewayMacAddress:
                            raise IxNetRestApiException(
                                "Gateway Mac Address is unresolved."
                            )
            ...
            for deviceGroup in topology["deviceGroup"]:
                try:
                    ...
                    if srcIpAddress == srcIp:
                        self.ixnObj.logInfo(
                            "Found srcIpAddress: %s. Getting Gatway IP address ..."
                            % srcIpAddress
                        )
                        response = self.ixnObj.getMultivalueValues(gatewayIpMultivalue)
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            for deviceGroup in topology["deviceGroup"]:
                for ethernet in deviceGroup["ethernet"]:
                    try:
                        if bool(
                            re.match(r"[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+", srcIpAddress)
                        ):
                            srcIpMultivalue = ethernet["ipv4"][0]["address"]
                            ipObj = ethernet["ipv4"][0]["href"]
                        else:
                            # IPv6 format:
                            # ['2000:0:0:1:0:0:0:2', '2000:0:0:2:0:0:0:2',
                            # '2000:0:0:3:0:0:0:2', '2000:0:0:4:0:0:0:2']
    ...
    def getInnerDeviceGroup(self, deviceGroupObj):
        ...
        if response.json():
            for innerDeviceGroup in response.json()[0]["links"]:
                ...
                deviceGroupObj.append(innerDeviceGroupObj)
    ...
    def getTopologyObjAndDeviceGroupObjByPortName(self, portName):
        ...
        for eachTopology in response.json():
            ...
            response = self.ixnObj.get(
                self.ixnObj.httpHeader + topologyObj + "/deviceGroup"
            )
    ...
    def getNetworkGroupObjByIp(self, networkGroupIpAddress):
        ...
        queryData = {
            ...
            "nodes": [
                ...
                {
                    "node": "ipv4PrefixPools",
                    "properties": ["networkAddress"],
                    "where": [],
                },
                {
                    "node": "ipv6PrefixPools",
                    "properties": ["networkAddress"],
                    "where": [],
                },
            ],
    ...
    def getIpAddrIndexNumber(self, ipAddress):
        ...
        for topology in topologyList.json():
            ...
            deviceGroupList = self.ixnObj.get(
                self.ixnObj.httpHeader + topologyObj + "/deviceGroup"
            )
            for deviceGroup in deviceGroupList.json():
                deviceGroupObj = deviceGroup["links"][0]["href"]
                ethernetList = self.ixnObj.get(
                    self.ixnObj.httpHeader + deviceGroupObj + "/ethernet"
                )
                for ethernet in ethernetList.json():
                    ethernetObj = ethernet["links"][0]["href"]
                    if "." in ipAddress:
                        ipList = self.ixnObj.get(
                            self.ixnObj.httpHeader + ethernetObj + "/ipv4"
                        )
                    if ":" in ipAddress:
                        ipList = self.ixnObj.get(
                            self.ixnObj.httpHeader + ethernetObj + "/ipv6"
                        )
                    ...
                    for ip in ipList.json():
                        ...
                        ipMultivalue = response.json()["address"]
                        response = self.ixnObj.get(
                            self.ixnObj.httpHeader + ipMultivalue + "?includes=values"
                        )
    ...
    def getIpv4ObjByPortName(self, portName=None):
            ...
            "nodes": [
                {
                    "node": "vport",
                    "properties": ["name"],
                    "where": [{"property": "name", "regex": portName}],
                }
            ],
        }
        ...
        queryData = {
            "from": "/",
            "nodes": [
                {"node": "topology", "properties": ["vports"], "where": []},
                {"node": "deviceGroup", "properties": [], "where": []},
                {"node": "ethernet", "properties": [], "where": []},
                {"node": "ipv4", "properties": [], "where": []},
            ],
    ...
    def activateIgmpHostSession(self, portName=None, ipAddress=None, activate=True):
        ...
        igmpHostActiveMultivalue = queryResponse.json()["result"][0]["igmpHost"][0][
            "active"
        ]
        ...
        self.ixnObj.configMultivalue(
            igmpHostActiveMultivalue,
    ...
    def enableDeviceGroup(self, deviceGroupObj=None, enable=True):
        ...
        enabledMultivalue = response.json()["enabled"]
        self.ixnObj.configMultivalue(
            enabledMultivalue, multivalueType="singleValue", data={"value": enable}
        )
    ...
    def activateRouterIdProtocol(self, routerId, protocol=None, activate=True):
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            for deviceGroup in topology["deviceGroup"]:
                ...
                routerIdList = self.ixnObj.getMultivalueValues(
                    routerIdMultivalue, silentMode=True
                )
                self.ixnObj.logInfo(
                    "activateRouterIdProtocols: Querying DeviceGroup for routerId %s: %s"
                    % (routerId, protocol)
                )
                ...
                if routerId in routerIdList:
                    ...
                    if (
                        protocol == "isisL3"
                        and deviceGroup["ethernet"][0]["isisL3"] != []
                    ):
                        protocolList.append(
                            deviceGroup["ethernet"][0]["isisL3"][0]["active"]
                        )

                    if deviceGroup["ethernet"][0]["ipv4"] != []:
                        if (
                            protocol == "igmpHost"
                            and deviceGroup["ethernet"][0]["ipv4"][0]["igmpHost"] != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv4"][0]["igmpHost"][0][
                                    "active"
                                ]
                            )
                        if (
                            protocol == "igmpQuerier"
                            and deviceGroup["ethernet"][0]["ipv4"][0]["igmpQuerier"]
                            != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv4"][0]["igmpQuerier"][0][
                                    "active"
                                ]
                            )
                        if (
                            protocol == "bgpIpv4Peer"
                            and deviceGroup["ethernet"][0]["ipv4"][0]["bgpIpv4Peer"]
                            != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv4"][0]["bgpIpv4Peer"][0][
                                    "active"
                                ]
                            )
                        if (
                            protocol == "ospfv2"
                            and deviceGroup["ethernet"][0]["ipv4"][0]["ospfv2"] != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv4"][0]["ospfv2"][0][
                                    "active"
                                ]
                            )
                    ...
                    if deviceGroup["ethernet"][0]["ipv6"] != []:
                        if (
                            protocol == "pimV6Interface"
                            and deviceGroup["ethernet"][0]["ipv6"][0]["pimV6Interface"]
                            != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv6"][0]["pimV6Interface"][
                                    0
                                ]["active"]
                            )
                        if (
                            protocol == "bgpIpv6Peer"
                            and deviceGroup["ethernet"][0]["ipv6"][0]["bgpIpv6Peer"]
                            != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv6"][0]["bgpIpv6Peer"][0][
                                    "active"
                                ]
                            )
                        if (
                            protocol == "ospfv3"
                            and deviceGroup["ethernet"][0]["ipv6"][0]["ospfv3"] != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv6"][0]["ospfv3"][0][
                                    "active"
                                ]
                            )
                        if (
                            protocol == "mldHost"
                            and deviceGroup["ethernet"][0]["ipv6"][0]["mldHost"] != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv6"][0]["mldHost"][0][
                                    "active"
                                ]
                            )
                        if (
                            protocol == "mldQuerier"
                            and deviceGroup["ethernet"][0]["ipv6"][0]["mldQuerier"]
                            != []
                        ):
                            protocolList.append(
                                deviceGroup["ethernet"][0]["ipv6"][0]["mldQuerier"][0][
                                    "active"
                                ]
                            )
                    ...
                    for protocolActiveMultivalue in protocolList:
                        try:
                            protocolActiveList = self.ixnObj.getMultivalueValues(
                                protocolActiveMultivalue
                            )
                            self.ixnObj.logInfo(
                            ...
                            self.ixnObj.logInfo(
                                "updatedValueList: %s" % protocolActiveList
                            )
                            self.ixnObj.configMultivalue(
                                protocolActiveMultivalue,
                                multivalueType="valueList",
    ...
    def activateRouterIdRouteRanges(
        self, protocol=None, routeRangeAddressList=None, activate=True
    ):
        """
        Description
            Activate the protocols based on the RouterId.
        ...
        Examples:
            1> activateRouterIdRouteRanges(
                routeRangeAddressList=[[['all'], ['all']]], protocol='ospf', activate=True)

            2> activateRouterIdRouteRanges(
                routeRangeAddressList=[[['all'], ['202.13.0.0', '202.23.0.0', '203.5.0.0']]],
                                                                 protocol='isis', activate=False)

            3> activateRouterIdRouteRanges(
                routeRangeAddressList=[[['192.0.0.2', '192.0.0.3'], ['202.11.0.0', '202.21.0.0']],
                                    [['192.0.0.1'], ['all']]], protocol='ospf', activate=False)

            4> activateRouterIdRouteRanges(
                routeRangeAddressList=[[['192.0.0.1', '192.0.0.3'], ['202.3.0.0', '202.23.0.0']]],
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            for deviceGroup in topology["deviceGroup"]:
                ...
                deviceGroupObjList.append(
                    (
                        deviceGroupObj,
                        deviceGroupMultiplier,
                        routerIdList,
                        routerIdMultivalue,
                    )
                )
        ...
        for deviceGroup in deviceGroupObjList:
            ...
            queryData = {
                ...
                "nodes": [
                    ...
                    {
                        "node": "ipv4PrefixPools",
                        "properties": ["networkAddress", "count"],
                        "where": [],
                    },
                    {"node": protocol, "properties": ["active"], "where": []},
                ],
            ...
            for networkGroup in queryResponse.json()["result"][0]["networkGroup"]:
                ...
                for ipv4Prefix in networkGroup["ipv4PrefixPools"]:
                    if ipv4Prefix[protocol] != []:
                        ...
                        ipv4PrefixPool = self.ixnObj.getMultivalueValues(
                            ipv4PrefixPoolMultivalue, silentMode=True
                        )
                        protocolMultivalue = ipv4Prefix[protocol][0]["active"]
                        protocolActiveList = self.ixnObj.getMultivalueValues(
                            protocolMultivalue, silentMode=True
                        )
                        totalCountForEachRouterId = (
                            ipv4Prefix["count"] // deviceGroupMultiplier
                        )
                        ...
                        for eachRouterId in deviceGroupRouterIdList:
                            ...
                            for item in routeRangeAddressList:
                                ...
                                if "all" not in currentUserDefinedRouterIdList:
                                    if (
                                        eachRouterId
                                        not in currentUserDefinedRouterIdList
                                    ):
                                        continue

                                if "all" in currentUserDefinedRouteRangeList:
                                    for index in range(
                                        routerIdIndexes[eachRouterId, "startingIndex"],
                                ...
                                if "all" not in currentUserDefinedRouteRangeList:
                                    for index in range(
                                        startingIndex, totalRouteRangeCount
                                    ):
                                        ipv4PrefixPool[
                                            index
                                        ]
                                        if (
                                            ipv4PrefixPool[index]
                                            in currentUserDefinedRouteRangeList
                                        ):
                                            protocolActiveList[index] = activate
    ...
    def modifyProtocolRoutes(self, **kwargs):
        ...
        if "networkGroupObj" not in kwargs:
            response = self.ixnObj.post(
                self.ixnObj.httpHeader + kwargs['name'] + "/networkGroup"
            )
            networkGroupObj = response.json()["links"][0]["href"]
        ...
        if "networkAddress" in kwargs:
            ...
            if "networkAddress" in kwargs:
                ...
                self.ixnObj.patch(
                    self.ixnObj.httpHeader + multiValue + "/counter",
                    data={
                        "start": kwargs["networkAddress"]["start"],
                        "step": kwargs["networkAddress"]["step"],
                        "direction": kwargs["networkAddress"]["direction"],
    ...
    def applyOnTheFly(self):
        ...
        """
        response = self.ixnObj.post(
            self.ixnObj.sessionUrl + "/globals/topology/operations/applyonthefly",
            data={"arg1": "{0}/globals/topology".format(self.ixnObj.sessionUrl)},
        )
        self.ixnObj.waitForComplete(
            response,
            self.ixnObj.sessionUrl
            + "/globals/topology/operations/applyonthefly"
            + response.json()["id"],
        )
            ...
            if currentPort != specifiedPort:
                ...
                if response.status_code == 200:
                    ...
                    for protocol in response.json()["links"]:
                        ...
                        if (
                            "enabled" in response.json()
                            and response.json()["enabled"] is True
                        ):
                            # Exclude ARP object
    ...
    def getProtocolListByPortNgpf(self, port=None, portName=None):
        ...
        response = self.ixnObj.get(
            self.ixnObj.sessionUrl + "/topology", silentMode=True
        )
        topologyList = [
            "%s/%s/%s" % (self.ixnObj.sessionUrl, "topology", str(i["id"]))
            for i in response.json()
        ...
        for topology in topologyList:
            ...
            for eachVport in vportList:
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + eachVport, silentMode=True
                )
                vportName = response.json()["name"]
                ...
                if port is not None:
                    ...
                    actualPort = self.portMgmtObj.getPhysicalPortFromVport([eachVport])[
                        0
                    ]
            ...
            deviceGroupList = [
                "%s/%s/%s" % (topology, "deviceGroup", str(i["id"]))
                for i in response.json()
            ]
            ...
            for deviceGroup in deviceGroupList:
                ...
                for ethernet in ethernetList:
                    ...
                    for layer3Ip in ipv4List + ipv6List:
                        ...
                        for protocol in response.json()["links"]:
                            currentProtocol = protocol["href"]
                            if bool(
                                re.match("^/api/.*(ipv4|ipv6)/[0-9]+$", currentProtocol)
                            ):
                                continue
                            if bool(
                                re.match(
                                    "^/api/.*(ipv4|ipv6)/[0-9]+/port$", currentProtocol
                                )
                            ):
                                continue
                            url = self.ixnObj.httpHeader + currentProtocol
                ...
                enabledProtocolList["deviceGroup"].insert(
                    len(enabledProtocolList), deviceGroupObjects
                )
                deviceGroupObjects = []
        ...
        self.ixnObj.logInfo(
            "\ngetProtocolListByPortNgpf: {0}".format(str(enabledProtocolList)),
            timestamp=False,
        )
        return enabledProtocolList
                    ...
                    if ipList:
                        for ipObj in ipList:
                            ...
                            if hostIp in ipHostList:
                                ...
                                deviceGroupObjects.append(
                                    "/api" + ethernet.split("/api")[1]
                                )
                                deviceGroupObjects.append(
                                    "/api" + ipList[0].split("/api")[1]
                                )
                                isHostIpFound = True

                        if isHostIpFound is False:
                            continue
                        ...
                        for layer3Ip in ipList:
                            ...
                            for protocol in response.json()["links"]:
                                ...
                                if bool(
                                    re.match(
                                        "^/api/.*(ipv4|ipv6)/[0-9]+$", currentProtocol
                                    )
                                ):
                                    continue
                                if bool(
                                ...
                                if response.json() == []:
                                    ...
                                    deviceGroupObjects.append(
                                        response.json()[0]["links"][0]["href"]
                                    )

                # Done with the current Device Group. Reset deviceGroupObjects for the next DG.
                if isHostIpFound:
                    topologyDict["deviceGroup"].insert(
                        len(topologyDict["deviceGroup"]), deviceGroupObjects
                    )
                    deviceGroupObjects = []
    ...
    def getEndpointObjByDeviceGroupName(self, deviceGroupName, endpointObj):
        ...
        # Loop each Topology and search for matching port or portName
        response = self.ixnObj.get(
            self.ixnObj.sessionUrl + "/topology", silentMode=False
        )
        topologyList = [
            "%s/%s/%s" % (self.ixnObj.sessionUrl, "topology", str(i["id"]))
            for i in response.json()
        ...
        for topology in topologyList:
            ...
            for response in response.json():
                ...
                # Get inner device group objects also.
                # Verify if there are additional device groups within a device group.
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + deviceGroupObj + "/deviceGroup"
                )
            ...
            for deviceGroupObj in deviceGroupList:
                ...
                if response.json()["name"] == deviceGroupName:
                    ...
                    if endpointObj == "networkGroup":
                        response = self.ixnObj.get(
                            deviceGroupObj + "/networkGroup", silentMode=False
                        )
                        networkGroupList = [
                            "%s/%s/%s" % (deviceGroupObj, "networkGroup", str(i["id"]))
                            for i in response.json()
                        ]
                    ...
                    for ethernet in ethernetList:
                        ...
                        response = self.ixnObj.get(
                            self.ixnObj.httpHeader + ethernet + "?links=true",
                            silentMode=False,
                        )
                        for ethernetChild in response.json()["links"]:
                            ...
                            if currentChildName == endpointObj:
                                response = self.ixnObj.get(
                                    self.ixnObj.httpHeader + ethernetChild["href"]
                                )
                                if response.json() == []:
                                    raise IxNetRestApiException(
                                        'getEndpointObjByDeviceGroupName: The endpointObj you specified ' +
                                        '"{0}" is not configured. No endpointObj found'.format(
                                            endpointObj
                                        )
                                    )
                            ...
                            # Search IPv4/IPv6
                            if currentChildName in ["ipv4"] or currentChildName in [
                                "ipv6"
                            ]:
                                ...
                                for child in response.json():
                                    for l3Child in child["links"]:
                                        ...
                                        currentL3ChildName = l3Child["href"].split("/")[
                                            -1
                                        ]
                                        if currentL3ChildName == endpointObj:
                                            ...
                                            if response.json() == []:
                                                raise IxNetRestApiException(
                                                    'getEndpointObjByDeviceGroupName: ' +
                                                    'The endpointObj you specified ' +
                                                    '"{0}" is not configured. No endpointObj found.'.format(
                                                        endpointObj
                                                    )
                                                )
    ...
    def getProtocolObjFromProtocolList(
        self, protocolList, protocol, deviceGroupName=None
    ):
        """
        Description
        ...
        Example usage:
            ...
            obj = protocolObj.getProtocolObjFromProtocolList(
                    protocolList['deviceGroup'], 'ethernet', deviceGroupName='DG2')
            ...
            if protocol in ["deviceGroup", "ethernet", "ipv4", "ipv6"]:
                for endpointObj in protocols:
                    if protocol == "deviceGroup":
                        ...
                        match = re.search(
                            r"(/api/v1/sessions/[0-9]+/ixnetwork/topology/[0-9]+/deviceGroup/[0-9]+)$",
                            endpointObj,
                        )
                        ...
                        if match:
                            ...
                            if deviceGroupName:
                                ...
                                response = self.ixnObj.get(
                                    self.ixnObj.httpHeader + deviceGroupObj,
                                    silentMode=True,
                                )
                                if deviceGroupName == response.json()["name"]:
                                    self.ixnObj.logInfo(
                                        str([endpointObj]), timestamp=False
                                    )
                                    return [endpointObj]
                            else:
                    ...
                    match = re.search(
                        r"(/api/v1/sessions/[0-9]+/ixnetwork/topology/[0-9]+/deviceGroup/[0-9]+).*/%s/[0-9]+$"
                        % protocol,
                        endpointObj,
                    )
                    if match:
                        ...
                        if deviceGroupName:
                            deviceGroupObj = match.group(1)
                            response = self.ixnObj.get(
                                self.ixnObj.httpHeader + deviceGroupObj, silentMode=True
                            )
                            if deviceGroupName == response.json()["name"]:
                ...
                if any(protocol in x for x in protocols):
                    ...
                    self.ixnObj.logInfo(
                        "Appending protocol: %s" % str([protocolObjectHandle]),
                        timestamp=False,
                    )
                ...
                for ethernet in ethernetList:
                    ...
                    for layer3Ip in ipv4List + ipv6List:
                        ...
                        for vport in vportList:
                            ...
                            self.ixnObj.logInfo(
                                "\tFound port configured: %s" % currentPort
                            )
        return portList
    ...
    def flapBgp(
        ...
        try:
            discoveredBgpName = queryResponse.json()["result"][0]["topology"][0][
                "deviceGroup"
            ][0]["ethernet"][0]["ipv4"][0]["bgpIpv4Peer"][0]["name"]
            if bgpName == discoveredBgpName:
                bgpObject = queryResponse.json()["result"][0]["topology"][0][
                    "deviceGroup"
                ][0]["ethernet"][0]["ipv4"][0]["bgpIpv4Peer"][0]["href"]
        except Exception:
            discoveredBgpName = queryResponse.json()["result"][0]["topology"][0][
                "deviceGroup"
            ][0]["ethernet"][0]["ipv6"][0]["bgpIpv6Peer"][0]["name"]
            if bgpName == discoveredBgpName:
                bgpObject = queryResponse.json()["result"][0]["topology"][0][
                    "deviceGroup"
                ][0]["ethernet"][0]["ipv6"][0]["bgpIpv6Peer"][0]["href"]

        if bgpObject is None:
            raise IxNetRestApiException("\nNo such bgp name found %s" % bgpName)

        self.flapBgpPeerNgpf(
            bgpObjHandle=bgpObject,
            enable=enable,
            flapList=ipInterfaceList,
            uptime=upTimeInSeconds,
            downtime=downTimeInSeconds,
        )

    def flapBgpPeerNgpf(
        self, bgpObjHandle, enable=True, flapList="all", uptime=0, downtime=0
    ):
        """
        Description
        ...
        Syntax
           POST = /api/v1/sessions/<int>/ixnetwork/topology -> next line is continue
                /<int>/deviceGroup/<int>/ethernet/<int>/ipv4/<int>/bgpIpv4Peer/<int>
        """
        ...
        self.ixnObj.patch(
            self.ixnObj.httpHeader + enableFlappingMultivalue + "/valueList",
            data={"values": flapOverlayList},
        )
        self.ixnObj.patch(
            self.ixnObj.httpHeader + upTimeMultivalue + "/valueList",
            data={"values": uptimeOverlayList},
        )
        self.ixnObj.patch(
            self.ixnObj.httpHeader + downTimeMultivalue + "/valueList",
            data={"values": downtimeOverlayList},
        )

    def flapBgpRoutesNgpf(
        self,
        prefixPoolObj,
        enable=True,
        ipRouteListToFlap="all",
        uptime=0,
        downtime=0,
        ip="ipv4",
    ):
        ...
        Syntax
           POST = For IPv4: http://{apiServerIp:port}/api/v1/sessions/ -> next line is continue
           <int>/ixnetwork/topology/<int>/deviceGroup/<int>/networkGroup/<int>/ipv4PrefixPools/<int>/bgpIPRouteProperty

            For IPv6: http://{apiServerIp:port}/api/v1/sessions/<int>/ -> next line is continue
            ixnetwork/topology/<int>/deviceGroup/<int>/networkGroup/<int>/ipv4PrefixPools/<int>/bgpV6IPRouteProperty
        """
        ...
        if ip == "ipv4":
            response = self.ixnObj.get(
                self.ixnObj.httpHeader + prefixPoolObj + "/bgpIPRouteProperty"
            )
        if ip == "ipv6":
            response = self.ixnObj.get(
                self.ixnObj.httpHeader + prefixPoolObj + "/bgpV6IPRouteProperty"
            )
    ...
    def enableProtocolRouteRange(self, routerId, protocol, enable=False):
        ...
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + deviceGroupObj + "/routerData"
        )
    ...
    def startStopIpv4Ngpf(self, ipv4ObjList, action="start"):
        ...
        if type(ipv4ObjList) != list:
            raise IxNetRestApiException(
                "startStopIpv4Ngpf error: The parameter ipv4ObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/operations/"
            + action
        )
        data = {"arg1": ipv4ObjList}
    ...
    def startStopBgpNgpf(self, bgpObjList, action="start"):
        ...
        if type(bgpObjList) != list:
            raise IxNetRestApiException(
                "startStopBgpNgpf error: The parameter bgpObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/bgpIpv4Peer/operations/"
            + action
        )
    ...
    def startStopOspfNgpf(self, ospfObjList, action="start"):
        ...
        if type(ospfObjList) != list:
            raise IxNetRestApiException(
                "startStopOspfNgpf error: The parameter ospfObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/ospfv2/operations/"
            + action
        )
    ...
    def startStopIgmpHostNgpf(self, igmpHostObjList, action="start"):
        ...
        if type(igmpHostObjList) != list:
            raise IxNetRestApiException(
                "igmpHostObjNgpf error: The parameter igmpHostObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/igmpHost/operations/"
            + action
        )
    ...
    def startStopPimV4InterfaceNgpf(self, pimV4ObjList, action="start"):
        ...
        Parameters
            pimV4ObjList: Provide a list of one or more PIMv4 object handles to start or stop.
                Ex: ["/api/v1/sessions/1/ixnetwork/topology/1/ -> next line is continue
                    deviceGroup/1/ethernet/1/ipv4/1/pimV4Interface/1", ...]

            action: start or stop
        """
        if type(pimV4ObjList) != list:
            raise IxNetRestApiException(
                "startStopPimV4InterfaceNgpf error: The parameter pimv4ObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/pimV4Interface/operations/"
            + action
        )
    ...
    def startStopMldHostNgpf(self, mldHostObjList, action="start"):
        ...
        if type(mldHostObjList) != list:
            raise IxNetRestApiException(
                "startStopMldHostNgpf error: The parameter mldHostObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv6/mldHost/operations/"
            + action
        )
    ...
    def startStopIsisL3Ngpf(self, isisObjList, action="start"):
        ...
        if type(isisObjList) != list:
            raise IxNetRestApiException(
                "startStopIsisL3Ngpf error: The parameter isisObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/isisL3/operations/"
            + action
        )
    ...
    def startStopLdpBasicRouterNgpf(self, ldpObjList, action="start"):
        ...
        if type(ldpObjList) != list:
            raise IxNetRestApiException(
                "startStopLdpBasicRouterNgpf error: The parameter ldpObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ldpBasicRouter/operations/"
            + action
        )
    ...
    def enableDisableIgmpGroupRangeNgpf(
        self, protocolSessionUrl, groupRangeList, action="disable"
    ):
        """
         Description:
        ...
        Parameters
            protocolSessionUrl: http://{apiServerIp:port}/api/v1/sessions/1/ -> next line is continue
                                ixnetwork/topology/1/deviceGroup/1/ethernet/1/ipv4/1/igmpHost/1
        ...
        if listOfIndexesToDisable == []:
            raise IxNetRestApiException(
                "disableIgmpGroupRangeNgpf Error: No multicast group range ip address found on your list"
            )
        ...
        for index in listOfIndexesToDisable:
            ...
            self.ixnObj.logInfo(
                "enableDisableIgmpGroupRangeNgpf: %s: %s"
                % (action, groupRangeValues[index])
            )
            response = self.ixnObj.post(
                currentOverlayUrl, data={"index": index + 1, "value": enableDisable}
            )

    def enableDisableMldGroupNgpf(
        self, protocolSessionUrl, groupRangeList, action="disable"
    ):
        """
         Description:
        ...
        for index in listOfIndexesToDisable:
            ...
            # NOTE:  Index IS NOT zero based.
            self.ixnObj.logInfo(
                "enableDisableMldGroupNgpf: %s: %s" % (action, groupRangeValues[index])
            )
            response = self.ixnObj.post(
                currentOverlayUrl, data={"index": index + 1, "value": enableDisable}
            )
    ...
    def sendIgmpJoinLeaveNgpf(
        self, routerId=None, igmpHostUrl=None, multicastIpAddress=None, action="join"
    ):
        """
        Description
        ...
        if routerId:
            ...
            if deviceGroupObj == 0:
                raise IxNetRestApiException(
                    "No Device Group found for router ID: %s" % routerId
                )

            queryData = {
                "from": deviceGroupObj,
                "nodes": [
                    {"node": "routerData", "properties": [], "where": []},
                    {"node": "ethernet", "properties": [], "where": []},
                    {"node": "ipv4", "properties": [], "where": []},
            ...
            if routerId in routerIdList:
                igmpHostUrl = queryResponse.json()["result"][0]["ethernet"][0]["ipv4"][
                    0
                ]["igmpHost"][0]["href"]

        # Based on the list of multicastIpAddress, get all their indexes.
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + igmpHostUrl + "/igmpMcastIPv4GroupList"
        )
        startMcastAddrMultivalue = response.json()["startMcastAddr"]
        listOfConfiguredMcastIpAddresses = self.ixnObj.getMultivalueValues(
            startMcastAddrMultivalue
        )

        self.ixnObj.logInfo(
            "sendIgmpJoinNgpf: List of configured Mcast IP addresses: %s"
            % listOfConfiguredMcastIpAddresses
        )
        if listOfConfiguredMcastIpAddresses == []:
            raise IxNetRestApiException(
                "sendIgmpJoinNgpf: No Mcast IP address configured"
            )
        ...
        data = {
            "arg1": [igmpHostUrl + "/igmpMcastIPv4GroupList"],
            "arg2": indexListToSend,
        }
    ...
    def sendPimV4JoinLeaveNgpf(
        self, routerId=None, pimObj=None, multicastIpAddress=None, action="join"
    ):
        """
        Description
        ...
        Parameters
            routerId: The Device Group Router ID address.
            pimObj: '/api/v1/sessions/1/ixnetwork/topology/1/ -> next line is continue
                    deviceGroup/1/ethernet/1/ipv4/1/pimV4Interface/1/pimV4JoinPruneList'
            multicastIpAddress: 'all' or a list of multicast IP addresses to send join.
                                 Example: ['225.0.0.3', '225.0.0.4']
            action: join|leave
        """
        ...
        if routerId:
            ...
            if routerId in routerIdList:
                pimObj = queryResponse.json()["result"][0]["ethernet"][0]["ipv4"][0][
                    "pimV4Interface"
                ][0]["href"]

        # Based on the list of multicastIpAddress, get all their indexes.
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + pimObj + "/pimV4JoinPruneList"
        )
        ...
        self.ixnObj.logInfo(
            "sendPimV4JoinNgpf: List of configured Mcast IP addresses: %s"
            % listOfConfiguredMcastIpAddresses
        )
        if listOfConfiguredMcastIpAddresses == []:
            raise IxNetRestApiException(
                "sendPimV4JoinNgpf: No Mcast IP address configured"
            )
    ...
    def sendMldJoinNgpf(self, mldObj, ipv6AddressList):
        ...
        for eachPortIdDetails in response.json():
            ...
            response = self.ixnObj.get(
                self.ixnObj.httpHeader + startMcastAddrMultivalue
            )
            ...
            for eachSpecifiedIpv6Addr in listOfGroupAddresses:
                if eachSpecifiedIpv6Addr in listOfConfiguredGroupIpAddresses:
                    ...
                    #      http://192.168.70.127.:11009/api/v1/sessions/1 -> next line is continue
                    # /ixnetwork/topology/1/deviceGroup/1/ -> next line is continue
                    # ethernet/1/ipv6/2/mldHost/1/mldMcastIPv6GroupList/port/1/operations/mldjoingroup
                    #    arg1: port/1 object
                    url = (
                        mldObj
                        + "/mldMcastIPv6GroupList/port/%s/operations/mldjoingroup"
                        % currentPortId
                    )
                    portIdObj = (
                        mldObj + "/mldMcastIPv6GroupList/port/%s" % currentPortId
                    )
                    # portIdObj = http:/{apiServerIp:port}/api/v1/sessions/1/ -> next line is continue
                    # ixnetwork/topology/1/deviceGroup/1/ethernet/1/ipv6/2/mldHost/1/mldMcastIPv6GroupList/port/1
    ...
    def sendMldLeaveNgpf(self, mldObj, ipv6AddressList):
        ...
        Parameters
            mldObj: http://{apiServerIp:port}/api/v1/sessions/1/ -> next line is continue
                    ixnetwork/topology/1/deviceGroup/1/ethernet/1/ipv6/2/mldHost/1
            ipv6AddressList: 'all' or a list of IPv6 addresses that must be EXACTLY how it is configured on the GUI.
        """
        # Loop all port objects to get user specified IPv6 address to send the leave.
        portObjectList = mldObj + "/mldMcastIPv6GroupList/port"
        # response = post.get(portObjectList)
        response = self.ixnObj.patch(portObjectList)
        for eachPortIdDetails in response.json():
            currentPortId = eachPortIdDetails["id"]
            # For each ID, get the 'startMcastAddr' multivalue
            startMcastAddrMultivalue = eachPortIdDetails["startMcastAddr"]
            ...
            for eachSpecifiedIpv6Addr in listOfGroupAddresses:
                if eachSpecifiedIpv6Addr in listOfConfiguredGroupIpAddresses:
                    # if 'values' match ipv4Address, do a join on:
                    #      http://{apiServerIp:port}/api/v1/sessions/1/ixnetwork/ -> next line is continue
                    #       topology/1/deviceGroup/1/ethernet/1/ipv6/2/mldHost/1
                    #       /mldMcastIPv6GroupList/port/1/operations/mldjoingroup
                    #    arg1: port/1 object
                    url = (
                        mldObj
                        + "/mldMcastIPv6GroupList/port/%s/operations/mldleavegroup"
                        % currentPortId
                    )
                    portIdObj = (
                        mldObj + "/mldMcastIPv6GroupList/port/%s" % currentPortId
    ...
    def getSessionStatus(self, protocolObj):
        ...
        """
        response = self.ixnObj.get(
            self.ixnObj.httpHeader + protocolObj + "?includes=sessionStatus",
            silentMode=True,
        )
    ...
    def showTopologies(self):
        ...
        queryData = {
            ...
            "nodes": [
                {
                    "node": "topology",
                    "properties": ["name", "status", "vports", "ports"],
                    "where": [],
                },
                {"node": "deviceGroup", "properties": ["name", "status"], "where": []},
                {
                    "node": "networkGroup",
                    "properties": ["name", "multiplier"],
                    "where": [],
                },
                {
                    "node": "ethernet",
                ...
                {
                    "node": "vlan",
                    "properties": ["name", "vlanId", "priority"],
                    "where": [],
                },
                {
                    "node": "ipv4",
                ...
                {
                    "node": "bgpIpv6Peer",
                    "properties": ["name", "status", "sessionStatus"],
                    "where": [],
                },
                {
                    "node": "ospfv2",
        ...
        for topology in queryResponse.json()["result"][0]["topology"]:
            self.ixnObj.logInfo(
                "TopologyGroup: {0}   Name: {1}".format(
                    topology["id"], topology["name"]
                ),
                timestamp=False,
            )
            self.ixnObj.logInfo(
                "    Status: {0}".format(topology["status"]), timestamp=False
            )
            ...
            for vportObj in vportObjList:
                vportResponse = self.ixnObj.get(
                    self.ixnObj.httpHeader + vportObj, silentMode=True
                )
                self.ixnObj.logInfo(
                    "    VportId: {0} Name: {1}  AssignedTo: {2}  State: {3}".format(
                        vportResponse.json()["id"],
            ...
            for deviceGroup in topology["deviceGroup"]:
                self.ixnObj.logInfo(
                    "    DeviceGroup:{0}  Name:{1}".format(
                        deviceGroup["id"], deviceGroup["name"]
                    ),
                    timestamp=False,
                )
                self.ixnObj.logInfo(
                    "\tStatus: {0}".format(deviceGroup["status"]),
                    end="\n\n",
                    timestamp=False,
                )
                for ethernet in deviceGroup["ethernet"]:
                    ...
                    self.ixnObj.logInfo(
                        "\tEthernet:{0}  Name:{1}".format(
                            ethernet["id"], ethernet["name"]
                        ),
                        timestamp=False,
                    )
                    self.ixnObj.logInfo(
                        "\t    Status: {0}".format(ethernet["status"]), timestamp=False
                    )
                    enableVlansResponse = self.ixnObj.get(
                        self.ixnObj.httpHeader + ethernet["enableVlans"],
                        silentMode=True,
                    )
                    enableVlansMultivalue = enableVlansResponse.json()["links"][0][
                        "href"
                    ]
                    enableVlansValues = self.getMultivalueValues(
                        enableVlansMultivalue, silentMode=True
                    )[0]
                    self.ixnObj.logInfo(
                    ...
                    for mac, vlan, ipv4, ipv6 in zip(
                        ...
                        self.ixnObj.logInfo(
                            "\tIPv4:{0} Status: {1}".format(ipv4["id"], ipv4["status"]),
                            timestamp=False,
                        )
                        macResponse = self.ixnObj.get(
                            self.ixnObj.httpHeader + ethernet["mac"], silentMode=True
                        )
                        macAddress = self.getMultivalueValues(
                            macResponse.json()["links"][0]["href"], silentMode=True
                        )

                        vlanResponse = self.ixnObj.get(
                            self.ixnObj.httpHeader + vlan["vlanId"], silentMode=True
                        )
                        vlanId = self.getMultivalueValues(
                            vlanResponse.json()["links"][0]["href"], silentMode=True
                        )

                        priorityResponse = self.ixnObj.get(
                            self.ixnObj.httpHeader + vlan["priority"], silentMode=True
                        )
                        vlanPriority = self.getMultivalueValues(
                            priorityResponse.json()["links"][0]["href"], silentMode=True
                        )

                        ipResponse = self.ixnObj.get(
                            self.ixnObj.httpHeader + ipv4["address"], silentMode=True
                        )
                        ipAddress = self.getMultivalueValues(
                            ipResponse.json()["links"][0]["href"], silentMode=True
                        )

                        gatewayResponse = self.ixnObj.get(
                            self.ixnObj.httpHeader + ipv4["gatewayIp"], silentMode=True
                        )
                        gateway = self.getMultivalueValues(
                            gatewayResponse.json()["links"][0]["href"], silentMode=True
                        )

                        prefixResponse = self.ixnObj.get(
                            self.ixnObj.httpHeader + ipv4["prefix"], silentMode=True
                        )
                        prefix = self.getMultivalueValues(
                            prefixResponse.json()["links"][0]["href"], silentMode=True
                        )

                        index = 1
                        self.ixnObj.logInfo(
                            "\t    {0:8} {1:14} {2:7} {3:9} {4:12} {5:16} {6:12} {7:7} {8:7}".format(
                                "Index",
                                "MacAddress",
                                "VlanId",
                                "VlanPri",
                        ...
                        for (
                            ...
                            self.ixnObj.logInfo(
                                "\t    {0:^5} {1:18} {2:^6} {3:^9} {4:13} {5:<15} {6:<13} {7:6} {8:7}".format(
                                    index,
                                    mac,
                                    vlanId,
                                    vlanPriority,
                        ...
                        if None not in ethernet["ipv6"]:
                            ipResponse = self.ixnObj.get(
                                self.ixnObj.httpHeader + ipv6["address"],
                                silentMode=True,
                            )
                            gatewayResponse = self.ixnObj.get(
                                self.ixnObj.httpHeader + ipv6["gatewayIp"],
                                silentMode=True,
                            )
                            prefixResponse = self.ixnObj.get(
                                self.ixnObj.httpHeader + ipv6["prefix"], silentMode=True
                            )
                            self.ixnObj.logInfo(
                                "\tIPv6:{0} Status: {1}".format(
                                    ipv6["id"], ipv6["status"]
                                ),
                                timestamp=False,
                            )
                            self.ixnObj.logInfo(
                                "\t    {0:8} {1:14} {2:7} {3:9} {4:12} {5:19} {6:18} {7:7} {8:7}".format(
                                    "Index",
                                    "MacAddress",
                                    "VlanId",
                                    "VlanPri",
                            ...
                            for (
                                ...
                                macResponse.json()["values"],
                                vlanResponse.json()["values"],
                                priorityResponse.json()["values"],
                                ethernet["sessionStatus"],
                                ipResponse.json()["values"],
                                gatewayResponse.json()["values"],
                                prefixResponse.json()["values"],
                                ipv6["sessionStatus"],
                            ):
                                self.ixnObj.logInfo(
                                    "\t    {0:^5} {1:18} {2:^6} {3:^9} {4:13} {5:<15} {6:<13} {7:8} {8:7}".format(
                                        index,
                                        mac,
                                        vlanId,
                                        vlanPriority,
                        ...
                        if ipv4["bgpIpv4Peer"] != []:
                            for bgpIpv4Peer in ipv4["bgpIpv4Peer"]:
                                ...
                                bgpIpv4PeerSessionStatus = self.getSessionStatus(
                                    bgpIpv4PeerHref
                                )

                                self.ixnObj.logInfo(
                                    "\tBGPIpv4Peer:{0}  Name:{1}".format(
                                        bgpIpv4Peer["id"],
                                        bgpIpv4Peer["name"],
                                    ),
                                    timestamp=False,
                                )
                                dutIpResponse = self.ixnObj.get(
                                    self.ixnObj.httpHeader + bgpIpv4Peer["dutIp"],
                                    silentMode=True,
                                )
                                dutIp = self.getMultivalueValues(
                                    dutIpResponse.json()["links"][0]["href"],
                                    silentMode=True,
                                )

                                typeResponse = self.ixnObj.get(
                                    self.ixnObj.httpHeader + bgpIpv4Peer["type"],
                                    silentMode=True,
                                )
                                typeMultivalue = typeResponse.json()["links"][0]["href"]
                                bgpType = self.getMultivalueValues(
                                    typeMultivalue, silentMode=True
                                )

                                localAs2BytesResponse = self.ixnObj.get(
                                    self.ixnObj.httpHeader
                                    + bgpIpv4Peer["localAs2Bytes"],
                                    silentMode=True,
                                )
                                localAs2BytesMultivalue = localAs2BytesResponse.json()[
                                    "links"
                                ][0]["href"]
                                localAs2Bytes = self.getMultivalueValues(
                                    localAs2BytesMultivalue, silentMode=True
                                )

                                flapResponse = self.ixnObj.get(
                                    self.ixnObj.httpHeader + bgpIpv4Peer["flap"],
                                    silentMode=True,
                                )
                                flap = self.getMultivalueValues(
                                    flapResponse.json()["links"][0]["href"],
                                    silentMode=True,
                                )

                                uptimeResponse = self.ixnObj.get(
                                    self.ixnObj.httpHeader + bgpIpv4Peer["uptimeInSec"],
                                    silentMode=True,
                                )
                                uptime = self.getMultivalueValues(
                                    uptimeResponse.json()["links"][0]["href"],
                                    silentMode=True,
                                )
                                downtimeResponse = self.ixnObj.get(
                                    self.ixnObj.httpHeader
                                    + bgpIpv4Peer["downtimeInSec"],
                                    silentMode=True,
                                )
                                downtime = self.getMultivalueValues(
                                    downtimeResponse.json()["links"][0]["href"],
                                    silentMode=True,
                                )
                                self.ixnObj.logInfo(
                                    "\t    Type: {0}  localAs2Bytes: {1}".format(
                                        bgpType[0], localAs2Bytes[0]
                                    ),
                                    timestamp=False,
                                )
                                self.ixnObj.logInfo(
                                    "\t    Status: {0}".format(bgpIpv4Peer["status"]),
                                    timestamp=False,
                                )
                                index = 1
                                ...
                                for dutIp, bgpSession, flap, uptime, downtime in zip(
                                    ...
                                    self.ixnObj.logInfo(
                                        "\t\t{0}: DutIp:{1} SessionStatus:{2} Flap:{3} upTime:{4} downTime:{5}".format(
                                            index,
                                            dutIp,
                                            bgpSession,
                                            flap,
                        ...
                        for ospfv2 in ipv4["ospfv2"]:
                            self.ixnObj.logInfo(
                                "\t    OSPFv2:{0}  Name:{1}".format(
                                    ospfv2["id"], ospfv2["name"]
                                ),
                                timestamp=False,
                            )
                            self.ixnObj.logInfo(
                                "\t\tStatus: {0}".format(ospfv2["status"]),
                                end="\n\n",
                                timestamp=False,
                            )
                        ...
                        for igmpHost in ipv4["igmpHost"]:
                            self.ixnObj.logInfo(
                                "\t    igmpHost:{0}  Name:{1}".format(
                                    igmpHost["id"], igmpHost["name"]
                                ),
                                timestamp=False,
                            )
                            self.ixnObj.logInfo(
                                "\t\tStatus: {0}".format(igmpHost["status"]),
                                end="\n\n",
                                timestamp=False,
                            )
                        for igmpQuerier in ipv4["igmpQuerier"]:
                            self.ixnObj.logInfo(
                                "\t    igmpQuerier:{0}  Name:{1}".format(
                                    igmpQuerier["id"],
                                    igmpQuerier["name"],
                                ),
                                timestamp=False,
                            ...
                            self.ixnObj.logInfo(
                                "\t\tStatus: {0}".format(igmpQuerier["status"]),
                                end="\n\n",
                                timestamp=False,
                            )
                        for vxlan in ipv4["vxlan"]:
                            self.ixnObj.logInfo(
                                "\t    vxlan:{0}  Name:{1}".format(
                                    vxlan["id"], vxlan["name"]
                                ),
                                timestamp=False,
                            )
                            self.ixnObj.logInfo(
                                "\tStatus: {0}".format(vxlan["status"]),
                                end="\n\n, timestamp=False",
                            )
                ...
                for networkGroup in deviceGroup["networkGroup"]:
                    self.ixnObj.logInfo(
                        "\n\tNetworkGroup:{0}  Name:{1}".format(
                            networkGroup["id"], networkGroup["name"]
                        ),
                        timestamp=False,
                    )
                    self.ixnObj.logInfo(
                        "\t    Multiplier: {0}".format(networkGroup["multiplier"]),
                        timestamp=False,
                    )
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader
                    ...
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader + response.json()[0]["networkAddress"],
                        silentMode=True,
                    )
                    startingAddressMultivalue = response.json()["links"][0]["href"]
                    startingAddress = self.getMultivalueValues(
                        startingAddressMultivalue, silentMode=True
                    )[0]
                    endingAddress = self.getMultivalueValues(
                        startingAddressMultivalue, silentMode=True
                    )[-1]

                    self.ixnObj.get(
                        self.ixnObj.httpHeader + prefixPoolHref, silentMode=True
                    )
                    self.ixnObj.logInfo(
                        "\t    StartingAddress:{0}  EndingAddress:{1}  Prefix:{2}".format(
                            startingAddress,
                            endingAddress,
                    ...
                    if None not in ethernet["ipv6"]:
                        for ipv6 in ethernet["ipv6"]:
                            ...
                            for bgpIpv6Peer in ipv6["bgpIpv6Peer"]:
                                self.ixnObj.logInfo(
                                    "\t    BGPIpv6Peer:{0}  Name:{1}".format(
                                        bgpIpv6Peer["id"], bgpIpv6Peer["name"]
                                    ),
                                    timestamp=False,
                                )
                            for ospfv3 in ipv6["ospfv3"]:
                                self.ixnObj.logInfo(
                                    "\t    OSPFv3:{0}  Name:{1}".format(
                                        ospfv3["id"], ospfv3["name"]
                                    ),
                                    timestamp=False,
                                )
                            for mldHost in ipv6["mldHost"]:
                                self.ixnObj.logInfo(
                                    "\t    mldHost:{0}  Name:{1}".format(
                                        mldHost["id"], mldHost["name"]
                                    ),
                                    timestamp=False,
                                )
                            for mldQuerier in ipv6["mldQuerier"]:
                                self.ixnObj.logInfo(
                                    "\t    mldQuerier:{0}  Name:{1}".format(
                                        mldQuerier["id"], mldQuerier["name"]
                                    ),
                                    timestamp=False,
                                )
            self.ixnObj.logInfo("\n", timestamp=False)
    ...
    def getBgpObject(self, topologyName=None, bgpAttributeList=None):
        ...
        queryResponse = self.ixnObj.query(data=queryData)
        try:
            bgpHostAttributes = queryResponse.json()["result"][0]["topology"][0][
                "deviceGroup"
            ][0]["ethernet"][0]["ipv4"][0]["bgpIpv4Peer"][0]
            return bgpHostAttributes
        except IndexError:
            raise IxNetRestApiException(
                "\nVerify the topologyName and bgpAttributeList input: {0} / {1}\n".format(
                    topologyName, bgpAttributeList
                )
            )

    def isRouterIdInDeviceGroupObj(self, routerId, deviceGroupObj):
        routerIdMultivalue = deviceGroupObj["routerData"][0]["routerId"]
        self.ixnObj.getMultivalueValues(
            routerIdMultivalue, silentMode=True
        )
    ...
    def configBgpNumberOfAs(self, routerId, numberOfAs):
        ...
        Description
            ...
            In the GUI, under NetworkGroup, BGP Route Range tab,
                    bottom tab ASPathSegments, enter number of AS # Segments.
        ...
        queryResponse = self.ixnObj.query(data=queryData)
        try:
            bgpStack = queryResponse.json()["result"][0]["networkGroup"][0][
                "ipv4PrefixPools"
            ][0]["bgpIPRouteProperty"][0]["bgpAsPathSegmentList"]
        except Exception:
            raise IxNetRestApiException(
                "No object found in DeviceGroup object:  deviceGroup/networkGroup/ipv4PrefixPools" +
                "/bgpIPRouteProperty/bgpAsPathSegmentList: %s"
                % deviceGroupObj
            )

        if bgpStack == []:
            return IxNetRestApiException(
                "No ipv4PrefixPools bgpIPRouteProperty object found."
            )

        bgpRouteObj = bgpStack[0]["href"]
        response = self.ixnObj.get(self.ixnObj.httpHeader + bgpRouteObj)
        response.json()["numberOfAsNumberInSegment"]
        self.ixnObj.patch(
            self.ixnObj.httpHeader + bgpRouteObj,
            data={"numberOfAsNumberInSegment": numberOfAs},
        )
    ...
    def configBgpAsPathSegmentListNumber(self, routerId, asNumber, indexAndAsNumber):
        ...
        try:
            bgpStack = queryResponse.json()["result"][0]["networkGroup"][0][
                "ipv4PrefixPools"
            ][0]["bgpIPRouteProperty"][0]["bgpAsPathSegmentList"][0]["bgpAsNumberList"][
                int(asNumber) - 1
            ]
        except Exception:
            raise IxNetRestApiException(
                "No object found in DeviceGroup object:  deviceGroup/networkGroup/ipv4PrefixPools" +
                "/bgpIPRouteProperty/bgpAsPathSegmentList/bgpAsNumberlist: %s"
                % deviceGroupObj
            )
        ...
        try:
            ...
            raise IxNetRestApiException(
                "The index that you indicated is out of range for the current AS list"
            )

        self.ixnObj.logInfo("Configuruing: %s" % bgpRouteObj)
        self.ixnObj.configMultivalue(
            asNumberMultivalue, "valueList", {"values": asNumberValueList}
        )
    ...
    def configBgpAsSetMode(self, routerId, asSetMode):
        ...
        self.ixnObj.configMultivalue(
            asSetModeMultivalue, "valueList", {"values": newList}
        )
            ...
            if type(value) is list:
                for keyValue in value:
                    ...
                    object = self.getObject(
                        keys=keyValue, ngpfEndpointName=ngpfEndpointName
                    )
    ...
    def getNgpfObjectHandleByName(self, ngpfEndpointObject=None, ngpfEndpointName=None):
        ...
        Examples:
           ...
           protocolObj.getNgpfObjectHandleByName(ngpfEndpointObject='bgpIpv4Peer', ngpfEndpointName='bgp_2')
                 return objectHandle:
                    /api/v1/sessions/1/ixnetwork/topology/1/deviceGroup/1/ethernet/1/ipv4/1/bgpIpv4Peer/2
           ...
           protocolObj.getNgpfObjectHandleByName(
            ngpfEndpointObject='ipv4PrefixPools', ngpfEndpointName='Basic IPv4 Addresses 1')
                 return objectHandle:
                    /api/v1/sessions/1/ixnetwork/topology/1/deviceGroup/1/networkGroup1/ipv4PrefixPools/1
        """
        ngpfMainObjectList = [
            "topology",
            "deviceGroup",
        ...
        if (
            ngpfEndpointObject
            not in ngpfL2ObjectList + ngpfL3ObjectList + ngpfMainObjectList
        ):
            raise IxNetRestApiException(
        ...
        if ngpfEndpointObject not in ngpfL2ObjectList + ngpfL3ObjectList:
            ...
            for eachNgpfEndpoint in ngpfMainObjectList[: ngpfEndpointIndex + 1]:
                ...
                if eachNgpfEndpoint == ngpfEndpointObject:
                    ...
                    nodesList.append(
                        {"node": eachNgpfEndpoint, "properties": [], "where": []}
                    )
        ...
        objectHandle = self.getObject(
            keys=queryResponse.json()["result"][0], ngpfEndpointName=ngpfEndpointName
        )
    ...
    def getNgpfObjectHandleByRouterId(self, ngpfEndpointObject, routerId):
        ...
        Example:
              ...
              protocolObj.getNgpfObject(ngpfEndpointObject='bgpIpv4Peer', routerId='193.0.0.1')
                 return objectHandle:
                    /api/v1/sessions/1/ixnetwork/topology/2/deviceGroup/1/ethernet/1/ipv4/1/bgpIpv4Peer/2
        ...
        if ngpfEndpointObject in ngpfL2ObjectList + ngpfL3ObjectList:
            ...
            nodesList.insert(
                len(nodesList),
                {"node": ngpfEndpointObject, "properties": [], "where": []},
            )
                    ...
                    for keyValue in value:
                        for key, value in keyValue.items():
                            ...
                            if key == "routerId":
                                ...
                                routerIdList = self.getMultivalueValues(
                                    routerIdMultivalue
                                )
                                if routerId in routerIdList:
                        ...
                        __getObject(keyValue)
                        if getObjectVar.foundRouterId is True:
                    ...
                    for deepKey, deepValue in keyValue.items():
                        if deepKey == "routerId":
                            ...
                            if routerId in value:
                                ...
                                match = re.match(
                                    "(/api.*)/routerData", keyValue["href"]
                                )
                                deviceGroupObj = match.group(1)
                                self.ixnObj.logInfo(
                                    "deviceGroupHandle for routerId: {0}\n\t{1}".format(
                                        routerId, deviceGroupObj
                                    ),
                                    timestamp=False,
                                )
                                return deviceGroupObj

                    object = self.getDeviceGroupByRouterId(
                        queryDict=keyValue, routerId=routerId, runQuery=False
                    )
                    if object is not None:
                        return object

    def getEthernetPropertyValue(
        self, routerId=None, ngpfEndpointName=None, property=None
    ):
        """
        Description
        ...
        if property not in ethernetProperties:
            raise IxNetRestApiException(
                "\nError: No such Ethernet property: %s.\n\nAvailable NGPF Ethernet properies: %s"
                % (property, ethernetProperties)
            )

        if routerId:
            ethernetObj = self.getNgpfObjectHandleByRouterId(
                routerId=routerId, ngpfEndpointObject="ethernet"
            )
    ...
    def sendNsNgpf(self, ipv6ObjList):
        ...
        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv6/operations/sendns"
        )
    ...
    def configIpv6Ngpf(
        ...
        Parameters
            ...
            kwargs:
               ipv6Address: <dict>:
                    {'start': '2000:0:0:1:0:0:0:1', 'direction': 'increment', 'step': '0:0:0:0:0:0:0:1'},
        ...
        # To modify
        if ngpfEndpointName:
            ipv6Obj = self.getNgpfObjectHandleByName(
                ngpfEndpointName=ngpfEndpointName, ngpfEndpointObject="ipv6"
            )
            createNewIpv6Obj = False
        ...
        if "name" in kwargs:
            self.ixnObj.patch(
                self.ixnObj.httpHeader + ipv6Obj, data={"name": kwargs["name"]}
            )

        if "multiplier" in kwargs:
            self.configDeviceGroupMultiplier(
                objectHandle=ipv6Obj,
                multiplier=kwargs["multiplier"],
                applyOnTheFly=False,
            )
        ...
        if "ipv6Address" in kwargs:
            ...
            if multivalueType == "random":
                ...
                self.configMultivalue(
                    multivalue, multivalueType, data=kwargs["ipv6Address"]
                )
            ...
            if "ipv6AddressPortStep" in kwargs:
                ...
                if kwargs["ipv6AddressPortStep"] != "disabled":
                    self.ixnObj.patch(
                        portStepMultivalue, data={"step": kwargs["ipv6AddressPortStep"]}
                    )
        ...
        if "resolveGateway" in kwargs:
            ...
            self.ixnObj.logInfo(
                'Configure IPv6 gateway to resolve gateway. Attribute for multivalueId = jsonResponse["resolveGateway"]'
            )
            self.configMultivalue(
                multivalue, "singleValue", data={"value": kwargs["resolveGateway"]}
            )
        ...
        if "prefix" in kwargs:
            ...
            self.configMultivalue(
                multivalue, "singleValue", data={"value": kwargs["prefix"]}
            )

        if createNewIpv6Obj is True:
            self.configuredProtocols.append(ipv6Obj)

        return ipv6Obj

    def configDeviceGroupMultiplier(
        self, objectHandle, multiplier, applyOnTheFly=False
    ):
        """
        Description
        ...
        """
        deviceGroupObject = re.search(r"(.*deviceGroup/\d).*", objectHandle)
    ...
    def startStopLdpBasicRouterV6Ngpf(self, ldpV6ObjList, action="start"):
        ...
        if type(ldpV6ObjList) != list:
            raise IxNetRestApiException(
                "startStopLdpBasicRouterV6Ngpf error: The parameter ldpV6ObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ldpBasicRouterV6/operations/"
            + action
        )
    ...
    def startStopLdpConnectedInterfaceNgpf(
        self, ldpConnectedIntObjList, action="start"
    ):
        """
        Description
        ...
        Parameters
            ...
            [
                "/api/v1/sessions/{id}/ixnetwork/topology/{id}/deviceGroup/{id}/" +
                ethernet/{id}/ipv4/{id}/ldpConnectedInterface/{id}", ...
                ]
            action: <str>: start or stop
        """
        if type(ldpConnectedIntObjList) != list:
            raise IxNetRestApiException(
                "startStopLdpConnectedInterfaceNgpf error: The parameter ldpObjList must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv4/ldpConnectedInterface/operations/"
            + action
        )
    ...
    def startStopLdpV6ConnectedInterfaceNgpf(
        self, ldpV6ConnectedIntObjList, action="start"
    ):
        """
        Description
        ...
        Parameters
            ldpV6ConnectedIntObjList: <list>:
            Provide a list of one or more ldpBasicRouter object handles to start or stop.
            Ex:
            [
                "/api/v1/sessions/{id}/ixnetwork/topology/{id}/" +
                "deviceGroup/{id}/ethernet/{id}/ipv6/{id}/ldpConnectedInterface/{id}", ...
            ]
            action = start or stop
        """
        if type(ldpV6ConnectedIntObjList) != list:
            raise IxNetRestApiException(
                "startStopLdpV6ConnectedInterfaceNgpf error: The parameter ldpV6ConnectedIntObjList " +
                "must be a list of objects."
            )

        url = (
            self.ixnObj.sessionUrl
            + "/topology/deviceGroup/ethernet/ipv6/ldpv6ConnectedInterface/operations/"
            + action
        )
    ...
    def verifyDhcpClientBind(self, deviceGroupName=None, protocol=None, **kwargs):
        ...
        for protocol in protocols:
            self.ixnObj.logInfo(
                "Verifying DHCP IDLE/BOUND/NOTSTARTED for {0} protocol".format(protocol)
            )
            deviceList = []
            ...
            if portName:
                ...
                response = self.ixnObj.get(
                    self.ixnObj.httpHeader + topology + "/deviceGroup"
                )
                ...
                ethObjList = self.getEndpointObjByDeviceGroupName(
                    deviceGroupName, "ethernet"
                )
                if ethObjList == []:
            ...
            for eachDevice in deviceList:
                ...
                for ethObj in ethObjList:
                    ...
                    if protocol == "ipv6":
                        response = self.ixnObj.get(
                            self.ixnObj.httpHeader
                            + ethObj
                            + "/dhcpv6client?includes=count"
                        )
                    else:
                        response = self.ixnObj.get(
                            self.ixnObj.httpHeader
                            + ethObj
                            + "/dhcpv4client?includes=count"
                        )
                ...
                for dhcpClientObj in dhcpClientObjList:
                    ...
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader + dhcpClientObj + "?includes=name"
                    )
                    dhcpObjName = str(response.json()["name"])
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader + dhcpClientObj + "?includes=count"
                    )
                    dhcpClientObjDeviceCount = response.json()["count"]
                    response = self.ixnObj.get(
                        self.ixnObj.httpHeader
                        + dhcpClientObj
                        + "?includes=discoveredAddresses"
                    )
                    ...
                    idleList = [
                        ...
                        if ("[Unresolved]" in discoveredAddressList[count])
                    ]
                    boundList = [
                        count + 1
                        for count in range(dhcpClientObjDeviceCount)
                        if ("[Unresolved]" not in discoveredAddressList[count])
                    ]
        ...
        idleBoundDict["Idle"] = {
            str(ele[1]): ele[2] for ele in filter(lambda x: x[0] == "Idle", ibList)
        }
        idleBoundDict["Bound"] = {
            str(ele[1]): ele[2] for ele in filter(lambda x: x[0] == "Bound", ibList)
        }
